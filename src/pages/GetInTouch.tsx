...
const GetInTouch: React.FC = () => {
  ...
  const sendEmailFunc = (e: React.MouseEvent<HTMLElement>) => {
    ...
    //service_tx0don8
    emailjs
      .sendForm("service_d4wi107", "template_xge5djo", currentForm, {
      ...
      <div className="gitContainer sectionPadding">
        ...
        <div className="gitInsider">
          <div className="ttmContainer">
            ...
            <a
              href="mailto:kattamurikowshiq@gmail.com"
              target="_blank"
              className="ttmBox"
            >
              <Card
                heading={"Email"}
                answer={"Kattamurikowshiq@gmail.com"}
                icon={MdOutlineAttachEmail}
                exist={true}
              />
            </a>
            <a
              href="https://wa.me/7036160563?text=hey%20Kattamuri"
              target="_blank"
              rel="noreferer"
              className="ttmBox"
            >
          ...
          <div className="writeMessageContainer">
            ...
            <form action="" className="form" ref={formRef}>
              ...
              <div className="inputBox">
                {" "}
                <label htmlFor="name" className="tinyText">
                  {" "}
                  Name
                </label>
                <input
              ...
              <div className="inputBox">
                <label htmlFor="Email" className="tinyText">
                  E-Mail
                </label>
                <input
                  id="Email"
              ...
              <div className="inputBox">
                <label htmlFor="Query" className="tinyText">
                  Query
                </label>
                <textarea
                  id="Query"
